...
M.core = function()
    ...
    highlight(0, "WinBar", { bg = bg, fg = green, bold = true })
    highlight(0, "WinBarError", { bg = bg, fg = red, italic = true, bold = true })
    highlight(0, "WinBarNC", { bg = bg, fg = cadet_blue })
    highlight(0, "WinSeparator", { link = "VertSplit" })
    highlight(0, "StatusLine", { bg = bg, fg = ash_blue, bold = true })
    ...
    highlight(0, "DiagnosticHint", { link = "NightflyEmerald" })
    if g.nightflyUndercurls then
        highlight(0, "DiagnosticUnderlineError", { fg = ash_blue, sp = red, undercurl = true })
        highlight(0, "DiagnosticUnderlineWarn", { fg = ash_blue, sp = yellow, undercurl = true })
        highlight(0, "DiagnosticUnderlineInfo", { fg = ash_blue, sp = blue, undercurl = true })
        highlight(0, "DiagnosticUnderlineHint", { fg = ash_blue, sp = emerald, undercurl = true })
    else
        highlight(0, "DiagnosticUnderlineError", { fg = ash_blue, sp = red, underline = true })
        highlight(0, "DiagnosticUnderlineWarn", { fg = ash_blue, sp = yellow, underline = true })
        highlight(0, "DiagnosticUnderlineInfo", { fg = ash_blue, sp = blue, underline = true })
        highlight(0, "DiagnosticUnderlineHint", { fg = ash_blue, sp = emerald, underline = true })
    end
    highlight(0, "DiagnosticVirtualTextError", { fg = steel_blue, italic = true, bold = true })
    highlight(0, "DiagnosticVirtualTextWarn", { fg = steel_blue, italic = true, bold = true })
    highlight(0, "DiagnosticVirtualTextInfo", { fg = steel_blue, italic = true, bold = true })
    highlight(0, "DiagnosticVirtualTextHint", { fg = steel_blue, italic = true, bold = true })
    ...
    highlight(0, "DiagnosticSignHint", { link = "NightflyEmeraldAlert" })
    ...
    highlight(0, "DiagnosticFloatingHint", { link = "NightflyEmerald" })
