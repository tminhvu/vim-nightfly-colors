...
M.core = function()
    ...
    if g.nightflyUndercurls then
        highlight(0, "DiagnosticUnderlineError", { sp = red, undercurl = true })
        highlight(0, "DiagnosticUnderlineWarn", { sp = yellow, undercurl = true })
        highlight(0, "DiagnosticUnderlineInfo", { sp = blue, undercurl = true })
        highlight(0, "DiagnosticUnderlineHint", { sp = emerald, undercurl = true })
    else
        highlight(0, "DiagnosticUnderlineError", { sp = red, underline = true })
        highlight(0, "DiagnosticUnderlineWarn", { sp = yellow, underline = true })
        highlight(0, "DiagnosticUnderlineInfo", { sp = blue, underline = true })
        highlight(0, "DiagnosticUnderlineHint", { sp = emerald, underline = true })
    end
